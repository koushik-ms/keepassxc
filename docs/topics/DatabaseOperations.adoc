...
To protect an attribute from being displayed by default, activate the _Protect_ checkbox *(A)*. To show the contents of the attribute without unprotecting it, press the _Reveal_ button *(B)*.
